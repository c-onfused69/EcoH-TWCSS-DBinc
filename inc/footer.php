      ...
      <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
        <div class="mb-10 w-full">
          ...
          <ul>
            ...
            <li>
              <a href="javascript:void(0)" class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                Features
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#faq" class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                FAQ
              </a>
            </li>
          </ul>
        ...
        <div class="w-full px-4 md:w-1/3 lg:w-1/2">
          <div class="my-1 flex justify-center md:justify-end">
            <p class="text-base text-[#f3f4fe]">
              ...
              <a href="https://tailgrids.com" rel="nofollow noopner" target="_blank" class="text-primary hover:underline">
                Group K
              </a>
            </p>
          </div>
